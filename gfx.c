...
//  gfx_map[TL_MUSH_2L2]   = ACS_VLINE | COLOR_PAIR(PAIR_BLUE) | A_BOLD;
  ...
  gfx_map[TL_BRIDGE_HELL]    = 'O'  | COLOR_PAIR(PAIR_BLACK) | A_BOLD;
  gfx_map[TL_BRIDGE_HELL_2]  = '\'' | COLOR_PAIR(PAIR_BLACK) | A_BOLD;
...
/*  gfx_map[TL_WEB_WEIGHT]  = '\'';
  ...
  gfx_map[TL_HELLWALL_HR] = ')' | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL11] = ACS_ULCORNER | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL12] = ACS_HLINE    | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL13] = ACS_VLINE    | COLOR_PAIR(PAIR_BROWN);
  gfx_map[TL_HELLWALL14] = ACS_HLINE    | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL15] = ACS_URCORNER | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL21] = ACS_LLCORNER | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL22] = '\''         | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL23] = ACS_PLUS     | COLOR_PAIR(PAIR_BROWN);
  gfx_map[TL_HELLWALL24] = '\''         | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL25] = ACS_LRCORNER | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL31] = '\\'    | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL32] = ACS_PLUS | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL33] = ACS_PLUS    | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL34] = ACS_PLUS | COLOR_PAIR(PAIR_RED);
  gfx_map[TL_HELLWALL35] = '/'    | COLOR_PAIR(PAIR_RED);
